            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <a href="<?php echo $baseUrl; ?>uploads/books/<?php echo $book['file_path']; ?>" class="btn btn-success w-100 mb-2" download>
                            <i class="fas fa-download me-1"></i> <?php echo $localization->t('download'); ?>
                        </a>
                        <?php else: ?>
                        <div class="alert alert-info">
                            <?php echo $localization->t('login_to_download'); ?>
                            <a href="<?php echo $baseUrl; ?>login" class="alert-link"><?php echo $localization->t('login'); ?></a>
                        </div>
                        <?php endif; ?>
                        
                        <a href="<?php echo $baseUrl; ?>books" class="btn btn-outline-secondary w-100">
